...
namespace Sirano.Data.Migrations
{
    ...
    [Migration("20230526155914_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sirano.Models.User", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sirano.Models.Footwear", b =>
                {
                    b.HasBaseType("Sirano.Models.Product");
            ...
            modelBuilder.Entity("Sirano.Models.Order", b =>
                {
                    ...
                    b.HasOne("Sirano.Models.User", "user")
                        .WithMany()
                        .HasForeignKey("userID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sirano.Models.Product", b =>
                {
                    b.HasOne("Sirano.Models.Review", "review")
                        .WithMany()
